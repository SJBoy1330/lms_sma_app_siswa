            ...
            <?php if ($result) : ?>
                <?php foreach ($result as $row) : ?>
                    <?php if ($row->redirect == true) : ?>
                        ...
                        <?php else : ?>
                            <a href="#" data-url_ajax="<?= base_url('qna/create_chat_grup'); ?>" data-post="id_staf,id_pelajaran" data-value="<?= $row->id_staf; ?>,<?= $row->id_pelajaran; ?>" <?= alert_question('KONFIRMASI', 'Apakah anda akan memulai chat di grup ' . $row->nama_pelajaran . ' ?'); ?> class="card mb-3 question_alert">
                            <?php endif; ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
