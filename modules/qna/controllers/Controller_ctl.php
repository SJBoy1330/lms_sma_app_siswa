...
class Controller_ctl extends MY_Frontend
{
	...
	public function index()
	{
		...
		$result_dua = curl_get('pesan/grup/', ['id_sekolah' => $this->id_sekolah, 'id_siswa' => $this->id_siswa]);
	...
	public function kontak_grup()
	{
		...
		// LOAD API
		$result = curl_get('pesan/kontak_grup/', ['id_sekolah' => $this->id_sekolah, 'id_siswa' => $this->id_siswa]);
	...
	public function create_chat_grup()
	{
		...
		// LOAD API
		$result = curl_post('pesan/create_grup/', ['id_sekolah' => $this->id_sekolah, 'id_siswa' => $this->id_siswa, 'id_staf' => $arr['id_staf'], 'id_pelajaran' => $arr['id_pelajaran']]);
		$data['status'] = $result->status;
		if ($result->status == 200) {
