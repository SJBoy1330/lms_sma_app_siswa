    ...
    (t = function () {
        ...
        return function (a, n) {
            ...
            if (i.defaults = {
                ...
                default_class: e(a)[0].classList.value, validParts: /dd?|DD?|mm?|MM?|yy(?:yy)?/g, dates: {
                    en: {
            ...
            }, null != i.options.calendarEvents) for (var o = 0; o < i.options.calendarEvents.length; o++) i.options.calendarEvents[o].id || console.log('%c Event named: "' + i.options.calendarEvents[o].name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"), i.isValidDate(i.options.calendarEvents[o].date) && (i.options.calendarEvents[o].date = i.formatDate(i.options.calendarEvents[o].date, i.options.format));
        ...
        var t = e.replace(this.initials.validParts, "\0").split("\0"), a = e.match(this.initials.validParts);
        ...
        var t = this, a = !t.$elements.calendarEl.hasClass("sidebar-hide"),
            n = !t.$elements.calendarEl.hasClass("event-hide"), i = e(window).width();
        ...
        if (i.children().length > 0 && i.empty(), t.options.calendarEvents) for (var o = 0; o < t.options.calendarEvents.length; o++) if (t.isBetweenDates(t.$active.date, t.options.calendarEvents[o].date)) r(t.options.calendarEvents[o]); else if (t.options.calendarEvents[o].everyYear) {
        ...
        var a = this, n = e(t.target).closest(".event-container"), i = e(n).data("eventIndex").toString(),
            o = a.options.calendarEvents.map(function (e) {
                return e.id.toString()
            }).indexOf(i), r = a.options.calendarEvents[o];
        ...
        var a = this, n = e(window).width(), i = !a.$elements.calendarEl.hasClass("sidebar-hide");
        ...
        var a, n, i, o = this;
        i = e(window).width(), void 0 === t || t.originalEvent ? e(o.$elements.calendarEl).toggleClass("event-hide") : t ? e(o.$elements.calendarEl).removeClass("event-hide") : e(o.$elements.calendarEl).addClass(""), i <= o.$breakpoints.tablet && i > o.$breakpoints.mobile && (n = !o.$elements.calendarEl.hasClass("event-hide"), a = !o.$elements.calendarEl.hasClass("sidebar-hide"), n && a && o.toggleSidebar())
    }, t.prototype.addCalendarEvent = function (e) {
        var t = this;

        function a(e) {
            if (e.id || console.log('%c Event named: "' + e.name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"), e.date instanceof Array) for (var a = 0; a < e.date.length; a++) n(e.date[a]) && (e.date[a] = t.formatDate(new Date(e.date[a]), t.options.format)); else n(e.date) && (e.date = t.formatDate(new Date(e.date), t.options.format));
        ...
        if (e instanceof Array) for (var n = 0; n < e.length; n++) a(e[n]); else "object" == typeof e && a(e)
        ...
        if (e instanceof Array) for (var n = 0; n < e.length; n++) a(e[n]); else a(e)
